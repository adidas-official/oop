// (7) Trojuhelnik - aplikace.cpp : Tento soubor obsahuje funkci main. Provádění programu se tam zahajuje a ukončuje.
//
...
void seradit_trojuhelniky_obvod()
{
...
void operace()
{
    ...
    do
    {
        ...
        case '3':
            seradit_trojuhelniky_obvod();
            break;

        case '4':
            seradit_trojuhelniky_obsah();
            break;

        case '5':
            odstranit_trojuhelnik();
            break;
